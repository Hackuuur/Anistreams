...
var EmailTemplate = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "AniStream is Best WebApp for Watch Anime and Download Mangas"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/Logo.png"), width: '150', height: '150', alt: 'Anistream', style: logo }),
                React.createElement(components_1.Text, { style: paragraph }, "Hi there,"),
                React.createElement(components_1.Text, { style: paragraph },
                    "Welcome to AniStream, the Streaming Platform for Watch ANime. Use the button below to ",
                    actionLabel,
                    "."),
