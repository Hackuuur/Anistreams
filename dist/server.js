        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                cartRouter.get("/", function (req, res) {
                    ...
                    return next_util_1.nextApp.render(req, res, "/cart", parseUrl.query);
                });
                ...
                app.use(function (req, res) { return (0, next_util_1.nextHandler)(req, res); }); //This line adds a middleware to the Express.js app
